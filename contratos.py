...
#     # Coluna do título
#     with col2:
#         st.markdown('<style>h1 { margin-left: 150px; font-size: 30px }</style>', unsafe_allow_html=True)
#         st.title('Painel de Contratos')
...
# # Número de contratos ao longo do tempo
...
#     text=df_valores_contratante['VALOR_FORMATADO'],  # Use a coluna formatada
#     textposition='auto',
#     orientation='h'
# ))
...
#     text=df_valores_licitacao['VALOR_FORMATADO'],  # Use a coluna formatada
#     textposition='auto',
#     orientation='h'
# ))
...
#     text=df_valores_natureza['VALOR_FORMATADO'],  # Use a coluna formatada
#     textposition='auto',
#     orientation='h'
# ))
...
def run_dashboard():
    st.sidebar.title("Painel de Contratos")

    if st.sidebar.button("Voltar ao Painel de Despesas"):
        st.session_state['painel'] = 'despesas'

    st.title("Painel de Contratos")
    st.write("Este é o painel de contratos. Mais funcionalidades serão adicionadas em breve.")
